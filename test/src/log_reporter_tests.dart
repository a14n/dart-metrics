...
import 'log_reporter_tests.mocks.dart';

@GenerateMocks([Logger, Counter, Histogram, Snapshot, Meter, Timer],
    customMocks: [MockSpec<MetricRegistry>(as: #MockMetricRegistry, fallbackGenerators: {#register: registryRegisterMockShim})
])
main() {
  group('log reporter', () {
    [Level.SEVERE, Level.INFO, Level.FINER].forEach((level) {
